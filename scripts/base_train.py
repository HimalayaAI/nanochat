...
from nanochat.flash_attention import ATTN_BACKEND, HAS_FA3, HAS_FA4, USE_FA3, USE_FA4
...
if USE_FA3:
    print0("✓ Using Flash Attention 3 backend.")
elif USE_FA4:
    print0("✓ Using Flash Attention 4 backend (experimental).")
else:
    print0("!" * 80)
    if HAS_FA3 and COMPUTE_DTYPE != torch.bfloat16:
        print0(f"WARNING: Flash Attention 3 only supports bf16, but COMPUTE_DTYPE={COMPUTE_DTYPE}. Using fallback backend.")
    elif HAS_FA4:
        print0("WARNING: Flash Attention 4 was detected but not selected. Using SDPA fallback.")
    else:
        print0("WARNING: Flash Attention backend not available, using PyTorch SDPA fallback")
